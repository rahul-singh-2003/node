...
## 2024-08-20, Version 22.7.0 (Current), @RafaelGSS
...
```text
buffer-write-string-short.js n=1000000 len=1 encoding='utf8'    131.19 % ±13.69% ±19.05% ±26.59%
buffer-write-string-short.js n=1000000 len=8 encoding='utf8'    200.61 % ±33.84% ±48.37% ±70.55%
buffer-write-string-short.js n=1000000 len=16 encoding='utf8'   231.98 % ±39.44% ±56.50% ±82.72%
buffer-write-string-short.js n=1000000 len=32 encoding='utf8'   286.10 % ±36.29% ±51.94% ±75.93%
buffer-copy.js n=6000000 partial='false' bytes=8                 38.98 %  ±1.00%  ±1.34%  ±1.75%
buffer-copy.js n=6000000 partial='true' bytes=8                 249.26 %  ±1.67%  ±2.24%  ±2.95%
buffer-copy.js n=6000000 partial='false' bytes=128               34.10 %  ±0.81%  ±1.08%  ±1.41%
buffer-copy.js n=6000000 partial='true' bytes=128               256.54 %  ±1.31%  ±1.75%  ±2.31%
```
...
* \[[`fa20300682`](https://github.com/nodejs/node/commit/fa20300682)] - **benchmark**: use assert.ok searchparams (Rafael Gonzaga) [#54334](https://github.com/nodejs/node/pull/54334)
...
* \[[`78008935b0`](https://github.com/nodejs/node/commit/78008935b0)] - **buffer**: properly apply dst offset and src length on fast path (Robert Nagy) [#54391](https://github.com/nodejs/node/pull/54391)
* \[[`c9dabe2927`](https://github.com/nodejs/node/commit/c9dabe2927)] - **buffer**: use fast API for writing one-byte strings (Robert Nagy) [#54311](https://github.com/nodejs/node/pull/54311)
* \[[`15c5f87479`](https://github.com/nodejs/node/commit/15c5f87479)] - **buffer**: optimize byteLength for short strings (Robert Nagy) [#54345](https://github.com/nodejs/node/pull/54345)
* \[[`015fc8fe68`](https://github.com/nodejs/node/commit/015fc8fe68)] - **buffer**: optimize byteLength for common encodings (Robert Nagy) [#54342](https://github.com/nodejs/node/pull/54342)
...
* \[[`e349dad370`](https://github.com/nodejs/node/commit/e349dad370)] - **build**: always disable strict aliasing (Michaël Zasso) [#54339](https://github.com/nodejs/node/pull/54339)
...
* \[[`c3b1a43608`](https://github.com/nodejs/node/commit/c3b1a43608)] - **cli**: allow `--test-[name/skip]-pattern` in `NODE_OPTIONS` (Aviv Keller) [#53001](https://github.com/nodejs/node/pull/53001)
...
* \[[`9df95e2037`](https://github.com/nodejs/node/commit/9df95e2037)] - **deps**: update amaro to 0.1.6 (Node.js GitHub Bot) [#54374](https://github.com/nodejs/node/pull/54374)
* \[[`df3e6bbfed`](https://github.com/nodejs/node/commit/df3e6bbfed)] - **deps**: update archs files for openssl-3.0.14+quic1 (Node.js GitHub Bot) [#54336](https://github.com/nodejs/node/pull/54336)
* \[[`a8c78c6f50`](https://github.com/nodejs/node/commit/a8c78c6f50)] - **deps**: upgrade openssl sources to quictls/openssl-3.0.14+quic1 (Node.js GitHub Bot) [#54336](https://github.com/nodejs/node/pull/54336)
...
* \[[`9f02b9a4b9`](https://github.com/nodejs/node/commit/9f02b9a4b9)] - **doc**: fix error description of the max header size (Egawa Ryo) [#54125](https://github.com/nodejs/node/pull/54125)
* \[[`72b7ca7878`](https://github.com/nodejs/node/commit/72b7ca7878)] - **doc**: add git node security --cleanup (Rafael Gonzaga) [#54381](https://github.com/nodejs/node/pull/54381)
* \[[`a7e142e5ac`](https://github.com/nodejs/node/commit/a7e142e5ac)] - **doc**: add note on weakness of permission model (Tobias Nießen) [#54268](https://github.com/nodejs/node/pull/54268)
* \[[`6a67fe50af`](https://github.com/nodejs/node/commit/6a67fe50af)] - **doc**: add versions when `--watch-preserve-output` was added (Théo LUDWIG) [#54328](https://github.com/nodejs/node/pull/54328)
* \[[`5b8b91f950`](https://github.com/nodejs/node/commit/5b8b91f950)] - **doc**: replace v19 mention in Current release (Rafael Gonzaga) [#54361](https://github.com/nodejs/node/pull/54361)
* \[[`814cb8096e`](https://github.com/nodejs/node/commit/814cb8096e)] - **doc**: correct peformance entry types (Jason Zhang) [#54263](https://github.com/nodejs/node/pull/54263)
* \[[`b7c10fefc5`](https://github.com/nodejs/node/commit/b7c10fefc5)] - **doc**: fix typo in method name in the sea doc (Eliyah Sundström) [#54027](https://github.com/nodejs/node/pull/54027)
...
* \[[`3eab8ceb03`](https://github.com/nodejs/node/commit/3eab8ceb03)] - **(SEMVER-MINOR)** **module**: add --experimental-transform-types flag (Marco Ippolito) [#54283](https://github.com/nodejs/node/pull/54283)
...
* \[[`1e3f7729ae`](https://github.com/nodejs/node/commit/1e3f7729ae)] - **src**: update compile cache storage structure (Joyee Cheung) [#54291](https://github.com/nodejs/node/pull/54291)
* \[[`04fe033ab0`](https://github.com/nodejs/node/commit/04fe033ab0)] - **src**: refactor http parser binding initialization (Joyee Cheung) [#54276](https://github.com/nodejs/node/pull/54276)
* \[[`c84f4d1fe7`](https://github.com/nodejs/node/commit/c84f4d1fe7)] - **src**: shift even moar x509 to ncrypto (James M Snell) [#54340](https://github.com/nodejs/node/pull/54340)
...
* \[[`d03f09073d`](https://github.com/nodejs/node/commit/d03f09073d)] - **src,test**: track `URL.canParse` fast API calls (Michaël Zasso) [#54356](https://github.com/nodejs/node/pull/54356)
...
* \[[`99fcabc80a`](https://github.com/nodejs/node/commit/99fcabc80a)] - **test**: make snapshot comparison more flexible (Shelley Vohr) [#54375](https://github.com/nodejs/node/pull/54375)
...
* \[[`92fa89f2ee`](https://github.com/nodejs/node/commit/92fa89f2ee)] - **test\_runner**: use validateStringArray for `timers.enable()` (Deokjin Kim) [#49534](https://github.com/nodejs/node/pull/49534)
* \[[`2cd8ef967e`](https://github.com/nodejs/node/commit/2cd8ef967e)] - **test\_runner**: report failures in filtered suites (Colin Ihrig) [#54387](https://github.com/nodejs/node/pull/54387)
* \[[`6fd3ea2dce`](https://github.com/nodejs/node/commit/6fd3ea2dce)] - **test\_runner**: remove parseCommandLine() from test.js (Colin Ihrig) [#54353](https://github.com/nodejs/node/pull/54353)
* \[[`d024141886`](https://github.com/nodejs/node/commit/d024141886)] - **test\_runner**: refactor hook creation (Colin Ihrig) [#54353](https://github.com/nodejs/node/pull/54353)
* \[[`32815ef42b`](https://github.com/nodejs/node/commit/32815ef42b)] - **test\_runner**: return setup() from parseCommandLine() (Colin Ihrig) [#54353](https://github.com/nodejs/node/pull/54353)
* \[[`56e6401135`](https://github.com/nodejs/node/commit/56e6401135)] - **test\_runner**: pass global options to createTestTree() (Colin Ihrig) [#54353](https://github.com/nodejs/node/pull/54353)
* \[[`10f940be3e`](https://github.com/nodejs/node/commit/10f940be3e)] - **test\_runner**: pass harness object as option to root test (Colin Ihrig) [#54353](https://github.com/nodejs/node/pull/54353)
* \[[`37f7765963`](https://github.com/nodejs/node/commit/37f7765963)] - **test\_runner**: use run() argument names in parseCommandLine() (Colin Ihrig) [#54353](https://github.com/nodejs/node/pull/54353)
